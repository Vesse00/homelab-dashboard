...
export default function Navbar() {
  ...
  // Zmienna pomocnicza do sprawdzania roli
  // Używamy rzutowania 'any', bo TypeScript może nie widzieć naszego rozszerzenia typu
      ...
      <div className="w-full h-16 px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {status === 'authenticated' ? (
            <>
              <button className="p-2 text-slate-400 hover:text-white hover:bg-white/10 rounded-full transition-all" title="Dodaj widget">
                <Plus size={20} />
              </button>
              ...
              <div className="relative ml-2">
                ...
                >
                  ...
                  <span className="text-sm font-medium hidden md:block text-slate-300">{userName}</span>
                </button>
                    ...
                    <>
                      ...
                      >
                        <div className="px-4 py-3 border-b border-white/10 mb-1 bg-white/5">
                          ...
                          <p className="text-[10px] text-slate-500 mt-1 uppercase tracking-widest">{userRole}</p>
                        </div>
            ...
            <Link href="/login" className="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white text-sm font-medium rounded-xl transition-colors">
              Zaloguj
            </Link>
          )}
        </div>
...
function DropdownItem({ icon, label, color = "text-slate-300", bgHover = "hover:bg-white/10" }: any) {
  return (
    <div className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors cursor-pointer ${color} ${bgHover} group`}>
