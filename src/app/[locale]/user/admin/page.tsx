...
export default function AdminPage() {
  ...
  const toggleRegistration = async () => {
    ...
    if (res.ok) {
      toast.success(newState ? t('registrationOpened') : t('registrationClosed'));
    } else {
  ...
  const confirmDelete = async () => {
    ...
    if (res.ok) {
      toast.success(t('userDeleted', { name: userToDelete.name }));
      fetchUsers();
    } else {
        ...
        <div className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              {registrationEnabled ? t('registrationOpenBtn') : t('registrationClosedBtn')}
            </button>
                          ...
                          {user.id !== currentUserId ? (
                            <>
                              <button 
                                ...
                                title={user.role === 'ADMIN' ? t('titleRevokeAdmin') : t('titleGrantAdmin')}
                              >
